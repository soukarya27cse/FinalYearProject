            ...
            {countries.map((country, i) => {
              ...
              return (
                <React.Fragment key={country}>
                  <Area dataKey={country + '_up'} stroke="transparent" fill={color + '10'} dot={false} legendType="none" />
                  <Area dataKey={country + '_dn'} stroke="transparent" fill={color + '10'} dot={false} legendType="none" />
                  <Line dataKey={country} stroke={color} dot={false} strokeWidth={2} name={country} />
                </React.Fragment>
              )
            })}
          </ComposedChart>
