...
const DarkTooltip = ({ active, payload, label }) => {
  ...
  return (
    <div style={{
      ...
      padding: '0.5rem 0.8rem', fontFamily: 'IBM Plex Mono, monospace',
      fontSize: '0.65rem', boxShadow: '0 4px 20px rgba(0,0,0,0.6)',
    }}>
      <div style={{ color: '#445566', marginBottom: 3, fontSize: '0.58rem' }}>{label}</div>
    ...
    <div className="chart-wrap">
      ...
      <ResponsiveContainer width="100%" height={220}>
        <LineChart data={lossData} margin={{ top: 5, right: 12, left: 0, bottom: 0 }}>
          ...
          <Legend wrapperStyle={{ fontFamily: 'IBM Plex Mono, monospace', fontSize: '0.6rem', color: '#7a91aa' }} />
          <ReferenceLine
            x={bestEpoch} stroke="rgba(251,176,59,0.35)" strokeDasharray="5 3"
            label={{ value: `▼ ${bestEpoch}`, position: 'insideTopRight', style: { fontFamily: 'IBM Plex Mono, monospace', fontSize: 9, fill: '#fbb03b' } }}
          />
